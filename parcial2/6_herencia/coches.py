...
class Camiones(Coches):
    def __init__(self, color, marca, modelo, velocidad, caballaje, plazas,eje,capacidad):
        super().__init__(color, marca, modelo, velocidad, caballaje, plazas)
        self.__eje = eje
        self.__capacidad = capacidad
    
    __tipoCarga = ""
    def cargar(self,tipoCarga):
...
class Camionetas(Coches):
    ...
    __numpas = ""
    def transportar(self,numpas):
        self.__numpas = numpas
        return self.__numpas
